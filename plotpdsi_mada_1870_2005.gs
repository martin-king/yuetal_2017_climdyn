...
*number of points 22: sum(maskout(enso.2,enso.2-1)/maskout(enso.2,enso.2-1),t=1,t=135)
*number of points 22: sum(maskout(enso.2,-enso.2-1)/maskout(enso.2,-enso.2-1),t=1,t=135)



*el nino between 1 to 20 std dev: 
*'compo=1.*ave(maskout(maskout(pdsi,enso.2-1.),-abs(enso.2)+20),t=1,t=135)'
...
'variance=ave(pow(maskout(maskout(pdsi,-enso.2-1.),-abs(enso.2)+20.)-compo,2),t=1,t=135)'
